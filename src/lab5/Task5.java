...
public class Task5 {
    public static void main(String[] args) {
        ...
        // Упражнение №3
        String str = "Вчера на уроке математики я твёрдо решил бяка, что мне пора жениться. А что? Я уже в третий бяка класс хожу,\n" +
        ...
        cutAndPasteWord(str,regex,replacement);
    ...
    public static void cutAndPasteWord(String str, String regex, String replacement) {
        String rightStr = str.replaceAll(regex, replacement);
